    ...
    <div className="bg-[#111] p-8 rounded-[30px] border border-white/10 space-y-8 w-full">
      ...
      <div className="grid grid-cols-1 xl:grid-cols-2 gap-10">
        <div className="space-y-6">
          ...
          <div>
            <label className="text-xs text-gray-400 flex justify-between mb-2 uppercase tracking-widest font-bold"><span>Meta Title</span> <span className={seo.metaTitle.length > 60 ? 'text-red-500' : 'text-gray-500'}>{seo.metaTitle.length}/60</span></label>
          ...
          <div>
            <label className="text-xs text-gray-400 flex justify-between mb-2 uppercase tracking-widest font-bold"><span>Meta Description</span> <span className={seo.metaDescription.length > 160 ? 'text-red-500' : 'text-gray-500'}>{seo.metaDescription.length}/160</span></label>
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              <label className="text-[10px] uppercase font-bold tracking-widest text-gray-400 mb-2 block">Focus Keyword</label>
            ...
            <div>
              <label className="text-[10px] uppercase font-bold tracking-widest text-gray-400 mb-2 block">URL Slug</label>
              <input value={seo.slug} onChange={e=>setSeo({...seo, slug: e.target.value.toLowerCase().replace(/[^a-z0-9-]/g,'-')})} className="w-full bg-black border border-white/20 p-3 rounded-lg text-sm text-[#00F0FF] outline-none focus:border-[#00F0FF]" />
            </div>
          </div>
